...
class CoDETR_Dual_Swin_Neck(BaseDetector):
    ...
    def __init__(
        ...
        super(CoDETR_Dual_Swin_Neck, self).__init__(
    ...
    def _load_from_state_dict(self, state_dict, prefix, local_metadata, strict, missing_keys, unexpected_keys, error_msgs):
        ...
        for k, v in state_dict.items():
            ...
            or ("backbone.norm" in k and "backbone.tir_norm"  not in k) or ("neck." in k and "neck2."  not in k) or ("query_head" in k and " query_head_tir"  not in k) \
