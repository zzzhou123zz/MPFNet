_base_ = ['co_dino_5scale_r50_lsj_8xb2_1x_gaiic_dual_stream_more_data_albu_with_Vis_3cls_dark_enhance_rotate_cbswin.py']
...
load_from = 'work_dirs/co_dino_5scale_swin_l_16xb1_16e_gaiic_dual_stream_o365_dual_swin_albu_with_Vis_3cls_drak_enhance_cbswin_rotate/epoch_3.pth'
model = dict(
    type='CoDETR_Dual_Swin_CBSwin',
    backbone=dict(
        _delete_=True,
        type='Dual_SwinTransformer_CBSwin',
