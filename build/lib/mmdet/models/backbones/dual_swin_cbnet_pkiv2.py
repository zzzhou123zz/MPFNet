...
class Dual_SwinTransformer_CBPkiv2(BaseModule):
    """ Swin Transformer
    ...
    def __init__(self,
        ...
        super(Dual_SwinTransformer_CBPkiv2, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(Dual_SwinTransformer_CBPkiv2, self).train(mode)
        self._freeze_stages()
