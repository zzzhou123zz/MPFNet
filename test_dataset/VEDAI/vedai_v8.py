...
# -----data related-----
data_root = '/data/zfy/dataset/vedai/'  # Root path of data
# Path of train annotation file
train_ann_file = 'annotations/train_class9.json'
train_data_prefix = 'train/rgb'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'annotations/val_class9.json'
val_data_prefix = 'val/rgb'  # Prefix of val image path

num_classes = 9  # Number of classes for classification
# classes = ('car', 'truck','tractor','camping car','van','vehicle', 'pick-up','motorcycles','bus')
classes = ()
