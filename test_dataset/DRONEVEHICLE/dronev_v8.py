...
# -----data related-----
data_root = '/data/zfy/dataset/dronevehicle/'  # Root path of data
# Path of train annotation file
train_ann_file = 'train.json'
train_data_prefix = 'train_1/rgb'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'val.json'
val_data_prefix = 'val_1/rgb'  # Prefix of val image path

num_classes = 5  # Number of classes for classification
# classes = (car,truck,bus,van,feright_car,feright,truvk,*)
classes = ()
...
nrom_cfg = dict(type='GN', num_groups=32, requires_grad=True)
